...
def main():
    ...
    paths += [*sorted((ROOT/'projects/watchman').rglob('*')),*sorted((ROOT/'projects/local-models').rglob('*')),*sorted((ROOT/'projects/front-desk').rglob('*')),ROOT/'projects/documents/README.md',ROOT/'projects/documents/README.pdf',*sorted((ROOT/'release').glob('*.md'))]
