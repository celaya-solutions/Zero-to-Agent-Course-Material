...
def main():
    errors=[]
    course=yaml.safe_load((COURSE/'course.yml').read_text())
    ...
    for n in range(1,6):
        ...
        m=yaml.safe_load((folder/'level.yml').read_text())
    ...
    saved=json.loads((COURSE/'level-01/assets/saved-runs.json').read_text())
