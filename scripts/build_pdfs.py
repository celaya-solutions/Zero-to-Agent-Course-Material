    ...
    for child in element:
        if child.tag=='a':
            ...
            if not href.startswith(('https://','http://','mailto:','#')):
                ...
                href = 'https://github.com/celaya-solutions/Zero-to-Agent-Course-Material/blob/v1.4.0-rc.1/' + quote(path.as_posix()) + ('#' + anchor if anchor else '')
...
def footer(canvas,doc):
    ...
    canvas.drawString(44,25,'ZERO TO AGENT | CELAYA SOLUTIONS LEARNING | v1.4.0-rc.1 REVIEW CANDIDATE')
